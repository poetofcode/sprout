...
class AuthViewModel(
    ...
    /*
        Как сделать закрытие по таймауту ?
        Во первых скорее всего должен запускаться таймаут
        Он должен запускаться во время, когда мы генерим новый Тост.
        Сам этот таймаут может быть реализован с помощью корутины.
        delay(3000)
